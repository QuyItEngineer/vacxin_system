...
<body>
  ...
  <div id="canvas">
    <div id="box_wrapper">
      ...
      <div class="container">
        <form action="" role="form" method="post" class="register">
          <div class="form-group">
            <label for="exampleInputEmail1">Full Name</label>
            <input type="text" class="form-control" id="exampleInputUserName" aria-describedby="TextHelp" placeholder="Enter Your Full Name">
