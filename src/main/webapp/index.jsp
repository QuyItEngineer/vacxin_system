...
<body>
  ...
  <div id="canvas">
    <div id="box_wrapper">
            ...
            <div class="col-lg-9 col-md-8 text-right">
              ...
              <nav class="mainmenu_wrapper">
                <ul class="mainmenu nav sf-menu">
                  ...
                  <li>
                    <a href="WEB-INF/pages/signin.jsp">Immunization</a>
                  </li>
      ...
      <section id="mainslider" class="ls mainslider">
        <div id="layerslider" style="width: 1920px; height: 800px;">
          ...
          <div class="ls-slide" data-ls="slidedelay: 5500;
            ...
            <p class="ls-l" style="top: 460px; left: 375px; white-space: nowrap;" data-ls="offsetxin:0;
                        durationin:1600;
                        delayin:2000;
          ...
          <div class="ls-slide" data-ls="slidedelay: 5500;
            ...
            <!-- slide background -->
            <img src="./images/slide_bg2.png" class="ls-bg" alt="Slide background">
            <img class="ls-l" src="./images/slide_man.png" alt="" style="top: 0px; left: 850px;" data-ls="offsetxin:100;
                        durationin:1000;
                        delayin:300;
                        transformoriginin: 50% 50% 30%;
                        easingin:easeOutQuint;
            ...
            <p class="ls-slide" style="top: 230px; left: 380px; white-space: nowrap; font-size: 50px; font-weight: 300;" data-ls="offsetxin:-100;
                        durationin:1200;
                        delayin:200;
                        easingin:easeOutExpo;
                        offsetxout:100;
            ...
            <h3 class="ls-slide" style="top: 290px; left: 372px; white-space: nowrap;" data-ls="offsetxin:-50;
                        durationin:1200;
                        delayin:900;
                        easingin:easeOutExpo;
                        offsetxout:50;
            ...
            <p class="ls-slide" style="top: 415px; left: 380px; white-space: nowrap;" data-ls="offsetxin:-150;
                        durationin:1200;
                        delayin:1400;
                        easingin:easeOutExpo;
                        offsetxout:-250;
            ...
            <div class="ls-slide" style="top: 490px; left: 375px; white-space: nowrap;" data-ls="offsetxin:0;
                        durationin:1600;
                        delayin:2000;
                        easingin:easeOutElastic;
                        offsetxout:left;
          ...
          <div class="ls-slide" data-ls="slidedelay: 5500;
            ...
            <!-- slide background -->
            <img src="./images/slide03.jpg" class="ls-bg" alt="Slide background">
            ...
            <div class="ls-slide" style="top: 410px; left: 375px; white-space: nowrap;" data-ls="offsetxin:0;
                        durationin:1600;
                        delayin:2000;
                        easingin:easeOutElastic;
                        offsetxout:left;
                  ...
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      ...
                      <p class="text-center social-icons">
                        <a class="fa fw fa-facebook magrin15px" href="#" title="Facebook" data-toggle="tooltip"></a>
                        <a class="fa fw fa-twitter magrin15px" href="#" title="Twitter" data-toggle="tooltip"></a>
                        <a class="fa fw fa-google-plus magrin15px" href="#" title="Google" data-toggle="tooltip"></a>
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    <div class="gallery-image">
                      ...
                      <div class="gallery-image-links">
                        ...
                        <a class="p-link fa fa-map-marker" title="" href="gallery-single.html"></a>
                      </div>
                    </div>
                  ...
                  <div>
                    <div class="gallery-image">
                      ...
                      <div class="gallery-image-links">
                        ...
                        <a class="p-link fa fw fa-map-marker" title="" href="gallery-single.html"></a>
                      </div>
                    </div>
                    <div class="gallery-item-description">
                      <h3>
                  ...
                  <div>
                    <div class="gallery-image">
                      ...
                      <div class="gallery-image-links">
                        ...
                        <a class="p-link fa fa-map-marker fa fa-map-marker" title="" href="gallery-single.html"></a>
                      </div>
                    </div>
                    <div class="gallery-item-description">
                      <h3>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div id="partners-carousel" class="owl-carousel" data-nav="true">
                <div>
                  <a href="#">
										<img src="./images/partners_grey/partner1.png" alt="">
									</a>
                ...
                <div>
                  <a href="#">
										<img src="./images/partners_grey/partner2.png" alt="">
									</a>
                ...
                <div>
                  <a href="#">
										<img src="./images/partners_grey/partner3.png" alt="">
									</a>
                ...
                <div>
                  <a href="#">
										<img src="./images/partners_grey/partner4.png" alt="">
									</a>
                ...
                <div>
                  <a href="#">
										<img src="./images/partners_grey/partner5.png" alt="">
									</a>
                ...
                <div>
                  <a href="#">
										<img src="./images/partners_grey/partner6.png" alt="">
									</a>
      ...
      <section id="contact" class="ls parallax section_padding_75 negative_margin page_contact">
        <div class="container">
          <div class="row">
            <div class="col-sm-4 to_animate" data-animation="pullDown">
              <div class="teaser text-center">
                <div class="teaser_icon highlight size_big">
                  <i class="fa fw fa-phone"></i>
                </div>
          ...
          <div class="row">
            <div class="col-sm-12 to_animate">
              <form class="contact-form cs parallax" method="post" action="/">
                <div class="row">
